...
---------------------------------------
### 이클립스 빌드툴로 실무에서 사용했을 적에는 리눅스 명령어를 전혀 사용하지 않아서 기본적인 add push pull을 간단하게 클릭만으로 사용하여 전혀 어려움이 없었는데 리눅스를 통해 다시 하려고 하니 정말   

### 생소하여 어려웠습니다. 또한 학원다닐때 사용했었던 GitHub대신 Jira 와 Jenkins, SVN에 익숙하여 Git과 GitHub 개념을 다시 익히는게 쉽지않았지만 이번 길드 분들의 도움을 받아서 끝까지 완료할 수있게 되어 정말로 기쁩니다.   
